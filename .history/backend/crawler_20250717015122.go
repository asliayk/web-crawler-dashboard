...
// Crawl fetches & analyzes one page.
func Crawl(target string) (*Result, error) {
	...
	// capture first KB for doctype while parsing full doc
	buf := &bytes.Buffer{}
	...
	if err != nil {
		return r, nil // return what we have
	}
	var links []string
	...
	// broken links (HEAD) with concurrency limit
