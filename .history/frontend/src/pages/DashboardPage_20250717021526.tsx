...
export default function DashboardPage() {
  ...
  async function loadData() {
    ...
    setError(null)
    try {
      // axios.defaults.baseURL should be set to http://localhost:8080/api
  ...
  useEffect(() => {
    ...
    const t = setInterval(loadData, 5000) // 5s
    ...
    <Container maxWidth="lg" sx={{ py: 4 }}>
      ...
      <Paper>
        {loading ? (
          ...
          <>
            {/* Set a max height so the table does NOT grow infinitely */}
